...
*/
    ...
    checkCUDAError("3D Leapfrog Kernel launch");
    ...
    printf("Total Execution Time on GPU for 3D Leapfrog kernel: %f ms\n", time2);
    ...
    FILE *file2 = fopen("LeapfrogTime_3D_data.txt", "w");
    if (file2 == NULL) {
    	fprintf(stderr, "Error opening LeapfrogTime_3D_data.txt file..\n");
	return 1;
    }
 #pragma unroll
    for (int i=0; i < N; i++) {
...
/*
    ...
    FILE *file_b = fopen("Leapfrog3DSolver.txt", "w");
    if (file_b == NULL) {
	    fprintf(stderr, "Error opening Leapfrog3DSolver.txt file..\n");
	    return 1;
    }
...
*/
    ...
    checkCUDAError("3D CrankNicolson Kernel launch");
    ...
    printf("Total Execution Time on GPU for 3D CrankNicolson kernel: %f ms\n", time3);
    ...
    FILE *file3 = fopen("CrankNicolsonTime_3D_data.txt", "w");
    if (file3 == NULL) {
    	fprintf(stderr, "Error opening CranknicolsonTime_3D_data.txt file..\n");
	    return 1;
    }
#pragma unroll
    for (int i=0; i < N; i++) {
...
/*
    ...
    FILE *file_c = fopen("CrankNicolson3DSolver.txt", "w");
    if (file_c == NULL) {
	    fprintf(stderr, "Error opening CrankNicolson3DSolver.txt file..\n");
	    return 1;
    }
    for (int k=0; k<size; k++) {
...
*/
    ...
    checkCUDAError("3D ADI Kernel launch");
    ...
    printf("Total Execution Time on GPU for 3D ADI kernel: %f ms\n", time4);
    ...
    FILE *file4 = fopen("ADITime_3D_data.txt", "w");
    if (file4 == NULL) {
    	fprintf(stderr, "Error opening ADITime_3D_data.txt file..\n");
	    return 1;
    }
#pragma unroll
    for (int i=0; i < N; i++) {
...
/*
    ...
    FILE *file_d = fopen("ADI3DSolver.txt", "w");
    if (file_d == NULL) {
	    fprintf(stderr, "Error opening ADI3DSolver.txt file..\n");
	    return 1;
    }
    for (int k=0; k<size; k++) {
	    fprintf(file_d, "%.6f\n", h_pp_ADI[k]);
...
*/
    ...
    checkCUDAError("3D Sigma Kernel launch");
    ...
    printf("Total Execution Time on GPU for 3D Sigma kernel: %f ms\n", time5);
    ...
    FILE *file5 = fopen("SigmaTime_3D_data.txt", "w");
    if (file5 == NULL) {
    	fprintf(stderr, "Error opening SigmaTime_3D_data.txt file..\n");
	    return 1;
    }
#pragma unroll
    for (int i=0; i < N; i++) {
...
/*
    ...
    FILE *file_e = fopen("Sigma3DSolver.txt", "w");
    if (file_e == NULL) {
	    fprintf(stderr, "Error opening Sigma3DSolver.txt file..\n");
	    return 1;
    }
    for (int k=0; k<size; k++) {
	    fprintf(file_e, "%.6f\n", h_pp_Sigma[k]);
...
*/
    ...
    checkCUDAError("3D LaxWendroff Kernel launch");
    ...
    printf("Total Execution Time on GPU for 3D LaxWendroff kernel: %f ms\n", time6);
    ...
    FILE *file6 = fopen("LaxWendroffTime_3D_data.txt", "w");
    if (file6 == NULL) {
    	fprintf(stderr, "Error opening LaxWendroffTime_3D_data.txt file..\n");
	    return 1;
    }
#pragma unroll
    for (int i=0; i < N; i++) {
...
/*
    ...
    FILE *file_f = fopen("LaxWendroff3DSolver.txt", "w");
    if (file_f == NULL) {
	    fprintf(stderr, "Error opening LaxWendroff3DSolver.txt file..\n");
	    return 1;
    }
    for (int k=0; k<size; k++) {
	    fprintf(file_f, "%.6f\n", h_pp_LaxWendroff[k]);
...
*/
    ...
    checkCUDAError("3D FractionalStep Kernel launch");
    ...
    printf("Total Execution Time on GPU for 3D FractionalStep kernel: %f ms\n", time7);
    ...
    FILE *file7 = fopen("FractionalStepTime_3D_data.txt", "w");
    if (file7 == NULL) {
    	fprintf(stderr, "Error opening FractionalStepTime_3D_data.txt file..\n");
	    return 1;
    }
#pragma unroll
    for (int i=0; i < N; i++) {
...
/*
    ...
    FILE *file_g = fopen("FractionalStep3DSolver.txt", "w");
    if (file_g == NULL) {
	    fprintf(stderr, "Error opening FractionalStep3DSolver.txt file..\n");
	    return 1;
    }
    for (int k=0; k<size; k++) {
...
*/
    ...
    checkCUDAError("3D MacCormack Kernel launch");
    ...
    printf("Total Execution Time on GPU for 3D MacCormack kernel: %f ms\n", time8);
    ...
    FILE *file8 = fopen("MacCormackTime_3D_data.txt", "w");
    if (file8 == NULL) {
    	fprintf(stderr, "Error opening MacCormackTime_3D_data.txt file..\n");
	    return 1;
    }
#pragma unroll
    for (int i=0; i < N; i++) {
...
/*
    ...
    FILE *file_h = fopen("MacCormack3DSolver.txt", "w");
    if (file_h == NULL) {
	    fprintf(stderr, "Error opening MacCormack3DSolver.txt file..\n");
	    return 1;
    }
    for (int k=0; k<size; k++) {
	    fprintf(file_h, "%.6f\n", h_pp_MacCormack[k]);
...
*/
    ...
    checkCUDAError("3D TVD Kernel launch");
    ...
    printf("Total Execution Time on GPU for 3D TVD kernel: %f ms\n", time9);
    ...
    FILE *file9 = fopen("TVDTime_3D_data.txt", "w");
    if (file9 == NULL) {
    	fprintf(stderr, "Error opening TVDTime_3D_data.txt file..\n");
	    return 1;
    }
#pragma unroll
    for (int i=0; i < N; i++) {
...
/*
    ...
    FILE *file_i = fopen("TVD3DSolver.txt", "w");
    if (file_i == NULL) {
	    fprintf(stderr, "Error opening TVD3DSolver.txt file..\n");
	    return 1;
    }
...
*/
    ...
    checkCUDAError("3D PSOR Kernel launch");
    ...
    printf("Total Execution Time on GPU for 3D PSOR kernel: %f ms\n", time10);
    ...
    FILE *file10 = fopen("PSORTime_3D_data.txt", "w");
    if (file10 == NULL) {
    	fprintf(stderr, "Error opening PSORTime_3D_data.txt file..\n");
	    return 1;
    }
#pragma unroll
    for (int i=0; i < N; i++) {
...
/*
    ...
    FILE *file_j = fopen("PSOR3DSolver.txt", "w");
    if (file_j == NULL) {
	    fprintf(stderr, "Error opening PSOR3DSolver.txt file..\n");
	    return 1;
    }
    for (int l=0; l<size; l++) {
	    fprintf(file_j, "%.6f\n", h_pp_PSOR[l]);
...
*/
    ...
    checkCUDAError("3D FVS Kernel launch");
    ...
    printf("Total Execution Time on GPU for 3D FVS kernel: %f ms\n", time11);
    ...
    FILE *file11 = fopen("FVSTime_3D_data.txt", "w");
    if (file11 == NULL) {
    	fprintf(stderr, "Error opening FVSTime_3D_data.txt file..\n");
	    return 1;
    }
#pragma unroll
    for (int i=0; i < N; i++) {
...
/*
    ...
    FILE *file_k = fopen("FVS3DSolver.txt", "w");
    if (file_k == NULL) {
	    fprintf(stderr, "Error opening FVS3DSolver.txt file..\n");
	    return 1;
    }
    for (int l=0; l<size; l++) {
	    fprintf(file_k, "%.6f\n", h_pp_FVS[l]);
